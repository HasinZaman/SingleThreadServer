mod http_body_enum_test {
    ...
    mod enum_to_string_test{
        ...
        fn application_test(){
            ...
            {
                let actual : ContentType = ContentType::Application(Value::Application::octet_stream);
            ...
            {
                let actual : ContentType = ContentType::Application(Value::Application::x_shockwave_flash);
            ...
            {
                let actual : ContentType = ContentType::Application(Value::Application::x_www_form_urlencoded);
        ...
        fn multipart_test(){
            ...
            {
                let actual : ContentType = ContentType::Multipart (Value::Multipart::form_data { boundary : String::from("")});
    ...
    mod string_to_enum_test {
        ...
        fn audio_mpeg_test(){
            string_to_enum_test(
                "audio/mpeg",
                ContentType::Audio (Value::Audio::mpeg )
            );
        }
        ...
        fn audio_x_wav_test(){
            string_to_enum_test(
                "audio/x-wav",
                ContentType::Audio (Value::Audio::x_wav )
            );
        }
        ...
        fn image_gif_test(){
            string_to_enum_test(
                "image/gif",
                ContentType::Image (Value::Image::gif )
            );
        }
        ...
        fn image_jpeg_test(){
            string_to_enum_test(
                "image/jpeg",
                ContentType::Image (Value::Image::jpeg )
            );
        }
        ...
        fn image_png_test(){
            string_to_enum_test(
                "image/png",
                ContentType::Image (Value::Image::png )
            );
        }
        ...
        fn image_tiff_test(){
            string_to_enum_test(
                "image/tiff",
                ContentType::Image (Value::Image::tiff )
            );
        }
        ...
        fn image_x_icon_test(){
            string_to_enum_test(
                "image/x-icon",
                ContentType::Image (Value::Image::x_icon )
            );
        }
        ...
        fn image_vnd_djvu_test(){
            string_to_enum_test(
                "image/vnd.djvu",
                ContentType::Image (Value::Image::vnd_djvu )
            );
        }
        ...
        fn image_svg_xml_test(){
            string_to_enum_test(
                "image/svg+xml",
                ContentType::Image (Value::Image::svg_xml )
            );
        }
        ...
        fn multipart_form_data_test(){
            string_to_enum_test(
                "multipart/form-data",
                ContentType::Multipart (Value::Multipart::form_data { boundary : String::from("")} )
            );
        }
        ...
        fn text_css_test(){
            string_to_enum_test(
                "text/css",
                ContentType::Text (Value::Text::css )
            );
        }
        ...
        fn text_csv_test(){
            string_to_enum_test(
                "text/csv",
                ContentType::Text (Value::Text::csv )
            );
        }
        ...
        fn text_html_test(){
            string_to_enum_test(
                "text/html",
                ContentType::Text (Value::Text::html )
            );
        }
        ...
        fn text_xml_test(){
            string_to_enum_test(
                "text/xml",
                ContentType::Text (Value::Text::xml )
            );
        }
        ...
        fn video_mpeg_test(){
            string_to_enum_test(
                "video/mpeg",
                ContentType::Video (Value::Video::mpeg )
            );
        }
        ...
        fn video_mp4_test(){
            string_to_enum_test(
                "video/mp4",
                ContentType::Video (Value::Video::mp4 )
            );
        }
        ...
        fn video_x_ms_wmv_test(){
            string_to_enum_test(
                "video/x-ms-wmv",
                ContentType::Video (Value::Video::x_ms_wmv )
            );
        }
        ...
        fn video_x_flv_test(){
            string_to_enum_test(
                "video/x-flv",
                ContentType::Video (Value::Video::x_flv )
            );
        }
        ...
        fn video_x_webm_test(){
            string_to_enum_test(
                "video/webm",
                ContentType::Video (Value::Video::webm )
            );
        }
    }
}
